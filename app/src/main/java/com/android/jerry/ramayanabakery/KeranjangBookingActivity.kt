...
import kotlinx.android.synthetic.main.activity_keranjang_booking.*
import kotlinx.android.synthetic.main.content_keranjang_booking.*
import java.lang.Exception
import java.text.DecimalFormat
import java.util.ArrayList
import java.util.HashMap

class KeranjangBookingActivity : AppCompatActivity() {

    internal var session: Session? = null
    private var cartData: List<Booking>? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_keranjang_booking)
        ...
        fab.setOnClickListener { view ->
            val i = Intent(this, TambahBookingActivity::class.java)
            startActivity(i)
        }
    ...
    private fun buildList(carts:List<Booking>) {
        Log.d("Room DB",">" + carts)
        val xitemList = ArrayList<HashMap<String, String>>()
        val formatter = DecimalFormat("#,###,###")
        for(cart:Booking in carts){
    ...
    private fun checkoutCart(){
        ...
        Ion.with(this@KeranjangBookingActivity)
                .load(url)
                    ...
                    try {
                        ...
                        if (status == "1") {
                            AlertDialog.Builder(this)
                                    ...
                                    .setTitle("Berhasil")
                                    .setMessage("Data booking berhasil ditambahkan")
    ...
    private fun deleteCart(cart:Booking){
        val task = Runnable {
            mDb?.bookingDao()?.deleteCart(cart)
            mUiHandler.post({
                fetchCartDataFromDb()
            })
        }
